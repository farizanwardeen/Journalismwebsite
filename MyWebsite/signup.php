...
include_once("forumconnect.php");
		$forumsql= "INSERT INTO
					forumusers(user_name, user_pass, user_email ,user_date, user_level)
				VALUES('" . mysqli_real_escape_string($con,$_POST['u']) . "',
					   '" . sha1($_POST['p']) . "',
					   '" . mysqli_real_escape_string($con,  $_POST['e']) . "',
						NOW(),
						0)";
						
		$forumresult = mysqli_query($con, $forumsql);
		if(!$forumresult)
		{
