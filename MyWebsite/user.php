...
<div id="pageMiddle">
  ...
  <hr />
  <hr />
  <btn-link is a button link>
  <p><a href="/websitecopy8/MyWebsite/userblog.php" class="btn btn-primary btn-small" target="_blank">Publish a post</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <a href="/websitecopy8/MyWebsite/rate.php" class="btn btn-primary btn-small" target="_blank">Rate Articles</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <a href="/websitecopy8/MyWebsite/wikiassignment.php" class="btn btn-primary btn-small" target="_blank">Assignment Desk</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   <?php 
   if($log_username=="farizanwardeen"){
   echo '<a href="/websitecopy8/MyWebsite/editorlounge.php" class="btn btn-primary btn-small" target="_blank">  Editor \'s Lounge</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
   echo '<a href="/websitecopy8/MyWebsite/newsblog/admin/login.php" class="btn btn-primary btn-small" target="_blank"> Admin Center</a></p>';
   }
   ?>
